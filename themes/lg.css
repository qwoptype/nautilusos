...
:root {
    ...
    --glass-border: rgba(43, 43, 43, 0.08);
    --pure-black: #000;
    --pure-white: #fff;
    --gray-dark: #888;
    --gray-light: #222;
    ...
    --transparent-white-5: var(--bg-secondary);
    --transparent-white-8: rgba(255, 255, 255, 0.08);
    --glass-shadow: box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12);
}
...
.login-input:focus {
    ...
    border: 2px solid transparent;
    background: var(--bg-secondary);
    box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12) !important;
}
...
#desktop {
    position: fixed;
    inset: 0;
    background: linear-gradient(135deg, var(--bg-primary) 0%, rgba(182, 182, 182, 0.1) 50%, var(--bg-primary) 100%);
    display: none;
    opacity: 0;
    transition: opacity 0.5s ease;
    font-family: "Inter" !important;
...
.wallpaper {
    position: absolute;
    inset: 0;
    background: linear-gradient(135deg, var(--bg-primary) 0%, rgba(173, 173, 173, 0.1) 50%, var(--bg-primary) 100%);
    z-index: 0;
    display: flex;
    flex-direction: column;
    align-items: center;
...
/* selection rectangle for desktop drag selection */
.selection-box, .selection-rect {
    position: absolute;
...
.start-search-input:focus~.start-search-icon {
...
.window {
    ...
    min-width: 400px;
    min-height: 300px;
    /* Force GPU acceleration to prevent black flashes */
...
.file-tree-item.folder.expanded>i.fa-chevron-down {
...
.calculator-btn.operator {
    background: rgba(84, 166, 221, 0.2);
    box-shadow: 0 0 0 1px rgba(106, 156, 185, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12);
    color: var(--accent);
}

.calculator-btn.operator:hover {
    background: rgba(84, 166, 221, 0.2) !important;
}
...
.calculator-btn.clear {
    background: rgba(239, 68, 68, 0.2);
    box-shadow: 0 0 0 1px rgba(255, 124, 124, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12);
    color: var(--error-red);
}
...
.settings-danger-btn {
    padding: 0.75rem 1.5rem;
    background: #58242438 !important;
    box-shadow: 0 0 0 1px rgba(212, 74, 74, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12) !important;
    border: none;
    border-radius: 10px;
    color: var(--error-red);
    cursor: pointer;
...
.theme-preview {
    width: 100%;
    height: 80px;
    background: linear-gradient(135deg, rgba(191, 211, 206, 0.2), rgba(77, 77, 77, 0.1));
    border-radius: 18px;
    display: flex;
    align-items: center;
    justify-content: center;
...
.cloaking-btn.primary {
    ...
    color: white;
    color: white;
    box-shadow: 0 0 0 1px rgba(118, 205, 255, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12);
    border: none !important;
    flex: 1;
}
...
.cloaking-status-indicator.active .cloaking-status-icon {
    background: rgba(55, 208, 255, 0.219);
    box-shadow: 0 0 0 1px rgba(0, 183, 255, 0.3), 0 16px 32px rgba(0, 0, 0, 0.12);
    color: var(--accent);
}
...
select {
    ...
    &::picker(select) {
        background: light-dark(white, var(--bg-secondary));
        border-radius: 15px;
